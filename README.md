...
git clone https://github.com/dz1995/GEO-skills.git && cd GEO-skills
bash vigilath-geo/install.sh --dir ~/.openclaw/skills

# 或者:交给 OpenClaw 的安装器
openclaw skills install git:dz1995/GEO-skills@main --global
```
...
|---|---|---|---|---|---|
| `vigilath-site-audit` | 给个网址,告诉你 AI 爬虫读不读得懂 | 1 个网址 | 30 秒 | **否** | 全量 25 类,不限次;**无墙** |
| `vigilath-seo-audit` | 传统搜索那套你还没做对的 12 项 | 1 个网址 | 30 秒 | **否** | 全量 12 类,不限次;**无墙** |
| `vigilath-mention` | 拿你的品牌去问 AI,把原话贴回来 | 品牌 + 行业词 | 1–3 分钟 | **否** | 每设备 2 次/30 天(按设备 + 出口 IP) |
| `vigilath-report` | 一份能发给老板的诊断报告 | 品牌 + 行业词 | 8–20 分钟 | 是 | 终身赠 1 次;之后按档配额 |
| `vigilath-radar` | 客户会怎么问 AI,你在哪些问题上不存在 | 品牌 | 30 秒 | 是 | 40 条候选全预览;**落库变持续跟踪 → 收费** |
| `vigilath-content` | 针对你缺席的问题写一篇能被引用的 | 选一条未命中问题 | 5 分钟 | 是 | 提纲 + 首段 + 合规结论;**全文 + 配图 → 收费** |
